...
let dislikeCount3 = document.querySelector('#dislikeCount3');
...
let likeCount4 = document.querySelector('#likeCount4');
let dislikeCount5 = document.querySelector('#dislikeCount5');

function count4(){
  likeCount4.value = parseInt(likeCount4.value) + 1;
}

function count5(){
  dislikeCount5.value = parseInt(dislikeCount5.value) + 1;
}
